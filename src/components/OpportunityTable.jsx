        ...
        <div className="h-full w-full">
            <TableVirtuoso
                ...
                components={{
                    ...
                    TableHead: React.forwardRef((props, ref) => <thead {...props} ref={ref} className="sticky top-0 z-10 bg-white dark:bg-slate-900" />),
                    TableRow: (props) => <tr {...props} className="group hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-b border-slate-100 dark:border-slate-800/50" />,
                }}
                fixedHeaderContent={() => (
                    <tr className="text-slate-500 border-b border-slate-200 dark:border-slate-800 text-xs uppercase tracking-wider bg-white dark:bg-slate-900">
